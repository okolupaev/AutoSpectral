...
* Speed up per-cell fluorophore optimization.
  ...
  + Update Jan-2026:
  + Parallelization via foreach will be faster and should not suffer from issues with memory overflow.
  + Speed up is now possible through strategic screening of variants for alignment with each cell's profile/residual.
...
* Fix the issue causing discontinuities.
  ...
  + Update Jan-2026: The "slow" method should now be fast enough to fix most of the issue.
