...
1) Trimming. 
*Update* Trimming will be deprecated soon and then phased out as an option.
...
*Update* Time-based cleaning will be deprecated soon and then phased out as an option.
